...
#in previous run model  failed trying to fit sigma
...
#restrict sigma
#in previous run model below failed trying to fit nu
...
#in previous runs model belwo failed trying to fit tau
