---
title: "SW RAVG gamlss with kfold June 2022"
...
SWRAVG_field<-SWRAVG_field[,c(1, 3, 13, 14, 24:47)]
...
### adj.lim.pdFVSVU  L_EA_rdnbr_with

Create predicted values of the response variable for the reserve dataset in order to calcualte confusion matrices, accuracies and kappa. 

Gamlss phrases nu and tau as odds.  The code below converts these odds of nu or tau into probabilities of 0 or 1, respectively. The predicted values are computed using the continuous response (mu) as well as the probability of zero or one.   

```{r SW RAVG adj.lim.pdFVSVU L_EA_rdnbr_with}
...
CBI.simple<-gamlss(formula=CBI.B~S_EA_rdnbr_with, nu.formula=~S_EA_rdnbr_with, tau.formula=~S_EA_rdnbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
BA.simple<-gamlss(formula=pdBA~S_EA_rdnbr_with, sigma.formula=~S_EA_rdnbr_with,nu.formula=~S_EA_rdnbr_with, tau.formula=~S_EA_rdnbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
### adj.lim.pdFVSVU  S_EA_rdnbr_with

Create predicted values of the response variable for the reserve dataset in order to calcualte confusion matrices, accuracies and kappa. 

Gamlss phrases nu and tau as odds.  The code below converts these odds of nu or tau into probabilities of 0 or 1, respectively. The predicted values are computed using the continuous response (mu) as well as the probability of zero or one.   

```{r SW RAVG adj.lim.pdFVSVU S_EA_rdnbr_with}
...
adj.lim.pdFVSVU.simple<-gamlss(formula=adj.lim.pdFVSVU~S_EA_rdnbr_with, sigma.formula=~S_EA_rdnbr_with,nu.formula=~S_EA_rdnbr_with, tau.formula=~S_EA_rdnbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
CBI.simple<-gamlss(formula=CBI.B~L_EA_dnbr_with, nu.formula=~L_EA_dnbr_with, tau.formula=~L_EA_dnbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
BA.simple<-gamlss(formula=pdBA~L_EA_dnbr_with, sigma.formula=~L_EA_dnbr_with,nu.formula=~L_EA_dnbr_with, tau.formula=~L_EA_dnbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
### adj.lim.pdFVSVU  L_EA_dnbr_with

Create predicted values of the response variable for the reserve dataset in order to calcualte confusion matrices, accuracies and kappa. 

Gamlss phrases nu and tau as odds.  The code below converts these odds of nu or tau into probabilities of 0 or 1, respectively. The predicted values are computed using the continuous response (mu) as well as the probability of zero or one.   

```{r SW RAVG adj.lim.pdFVSVU L_EA_dnbr_with}
...
adj.lim.pdFVSVU.simple<-gamlss(formula=adj.lim.pdFVSVU~L_EA_dnbr_with, sigma.formula=~L_EA_dnbr_with,nu.formula=~L_EA_dnbr_with, tau.formula=~L_EA_dnbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
CBI.simple<-gamlss(formula=CBI.B~S_EA_dnbr_with, nu.formula=~S_EA_dnbr_with, tau.formula=~S_EA_dnbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
BA.simple<-gamlss(formula=pdBA~S_EA_dnbr_with, sigma.formula=~S_EA_dnbr_with,nu.formula=~S_EA_dnbr_with, tau.formula=~S_EA_dnbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
### adj.lim.pdFVSVU  S_EA_dnbr_with

Create predicted values of the response variable for the reserve dataset in order to calcualte confusion matrices, accuracies and kappa. 

Gamlss phrases nu and tau as odds.  The code below converts these odds of nu or tau into probabilities of 0 or 1, respectively. The predicted values are computed using the continuous response (mu) as well as the probability of zero or one.   

```{r SW RAVG adj.lim.pdFVSVU S_EA_dnbr_with}
...
adj.lim.pdFVSVU.simple<-gamlss(formula=adj.lim.pdFVSVU~S_EA_dnbr_with, sigma.formula=~S_EA_dnbr_with,nu.formula=~S_EA_dnbr_with, tau.formula=~S_EA_dnbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
CBI.simple<-gamlss(formula=CBI.B~L_EA_rbr_with, nu.formula=~L_EA_rbr_with, tau.formula=~L_EA_rbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
BA.simple<-gamlss(formula=pdBA~L_EA_rbr_with, sigma.formula=~L_EA_rbr_with,nu.formula=~L_EA_rbr_with, tau.formula=~L_EA_rbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
### adj.lim.pdFVSVU  L_EA_rbr_with

Create predicted values of the response variable for the reserve dataset in order to calcualte confusion matrices, accuracies and kappa. 

Gamlss phrases nu and tau as odds.  The code below converts these odds of nu or tau into probabilities of 0 or 1, respectively. The predicted values are computed using the continuous response (mu) as well as the probability of zero or one.   

```{r SW RAVG adj.lim.pdFVSVU L_EA_rbr_with}
...
adj.lim.pdFVSVU.simple<-gamlss(formula=adj.lim.pdFVSVU~L_EA_rbr_with, sigma.formula=~L_EA_rbr_with,nu.formula=~L_EA_rbr_with, tau.formula=~L_EA_rbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
CBI.simple<-gamlss(formula=CBI.B~S_EA_rbr_with, nu.formula=~S_EA_rbr_with, tau.formula=~S_EA_rbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
BA.simple<-gamlss(formula=pdBA~S_EA_rbr_with, sigma.formula=~S_EA_rbr_with,nu.formula=~S_EA_rbr_with, tau.formula=~S_EA_rbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
### adj.lim.pdFVSVU  S_EA_rbr_with

Create predicted values of the response variable for the reserve dataset in order to calcualte confusion matrices, accuracies and kappa. 

Gamlss phrases nu and tau as odds.  The code below converts these odds of nu or tau into probabilities of 0 or 1, respectively. The predicted values are computed using the continuous response (mu) as well as the probability of zero or one.   

```{r SW RAVG adj.lim.pdFVSVU S_EA_rbr_with}
...
adj.lim.pdFVSVU.simple<-gamlss(formula=adj.lim.pdFVSVU~S_EA_rbr_with, sigma.formula=~S_EA_rbr_with,nu.formula=~S_EA_rbr_with, tau.formula=~S_EA_rbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
CBI.simple<-gamlss(formula=CBI.B~L_IA_rdnbr_with, nu.formula=~L_IA_rdnbr_with, tau.formula=~L_IA_rdnbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
BA.simple<-gamlss(formula=pdBA~L_IA_rdnbr_with, sigma.formula=~L_IA_rdnbr_with,nu.formula=~L_IA_rdnbr_with, tau.formula=~L_IA_rdnbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
### adj.lim.pdFVSVU  L_IA_rdnbr_with

Create predicted values of the response variable for the reserve dataset in order to calcualte confusion matrices, accuracies and kappa. 

Gamlss phrases nu and tau as odds.  The code below converts these odds of nu or tau into probabilities of 0 or 1, respectively. The predicted values are computed using the continuous response (mu) as well as the probability of zero or one.   

```{r SW RAVG adj.lim.pdFVSVU L_IA_rdnbr_with}
...
adj.lim.pdFVSVU.simple<-gamlss(formula=adj.lim.pdFVSVU~L_IA_rdnbr_with, sigma.formula=~L_IA_rdnbr_with,nu.formula=~L_IA_rdnbr_with, tau.formula=~L_IA_rdnbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
CBI.simple<-gamlss(formula=CBI.B~S_IA_rdnbr_with, nu.formula=~S_IA_rdnbr_with, tau.formula=~S_IA_rdnbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
BA.simple<-gamlss(formula=pdBA~S_IA_rdnbr_with, sigma.formula=~S_IA_rdnbr_with,nu.formula=~S_IA_rdnbr_with, tau.formula=~S_IA_rdnbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
### adj.lim.pdFVSVU  S_IA_rdnbr_with

Create predicted values of the response variable for the reserve dataset in order to calcualte confusion matrices, accuracies and kappa. 

Gamlss phrases nu and tau as odds.  The code below converts these odds of nu or tau into probabilities of 0 or 1, respectively. The predicted values are computed using the continuous response (mu) as well as the probability of zero or one.   

```{r SW RAVG adj.lim.pdFVSVU S_IA_rdnbr_with}
...
adj.lim.pdFVSVU.simple<-gamlss(formula=adj.lim.pdFVSVU~S_IA_rdnbr_with, sigma.formula=~S_IA_rdnbr_with,nu.formula=~S_IA_rdnbr_with, tau.formula=~S_IA_rdnbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
CBI.simple<-gamlss(formula=CBI.B~L_IA_dnbr_with, nu.formula=~L_IA_dnbr_with, tau.formula=~L_IA_dnbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
BA.simple<-gamlss(formula=pdBA~L_IA_dnbr_with, sigma.formula=~L_IA_dnbr_with,nu.formula=~L_IA_dnbr_with, tau.formula=~L_IA_dnbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
### adj.lim.pdFVSVU  L_IA_dnbr_with

Create predicted values of the response variable for the reserve dataset in order to calcualte confusion matrices, accuracies and kappa. 

Gamlss phrases nu and tau as odds.  The code below converts these odds of nu or tau into probabilities of 0 or 1, respectively. The predicted values are computed using the continuous response (mu) as well as the probability of zero or one.   

```{r SW RAVG adj.lim.pdFVSVU L_IA_dnbr_with}
...
adj.lim.pdFVSVU.simple<-gamlss(formula=adj.lim.pdFVSVU~L_IA_dnbr_with, sigma.formula=~L_IA_dnbr_with,nu.formula=~L_IA_dnbr_with, tau.formula=~L_IA_dnbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
CBI.simple<-gamlss(formula=CBI.B~S_IA_dnbr_with, nu.formula=~S_IA_dnbr_with, tau.formula=~S_IA_dnbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
BA.simple<-gamlss(formula=pdBA~S_IA_dnbr_with, sigma.formula=~S_IA_dnbr_with,nu.formula=~S_IA_dnbr_with, tau.formula=~S_IA_dnbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
### adj.lim.pdFVSVU  S_IA_dnbr_with

Create predicted values of the response variable for the reserve dataset in order to calcualte confusion matrices, accuracies and kappa. 

Gamlss phrases nu and tau as odds.  The code below converts these odds of nu or tau into probabilities of 0 or 1, respectively. The predicted values are computed using the continuous response (mu) as well as the probability of zero or one.   

```{r SW RAVG adj.lim.pdFVSVU S_IA_dnbr_with}
...
adj.lim.pdFVSVU.simple<-gamlss(formula=adj.lim.pdFVSVU~S_IA_dnbr_with, sigma.formula=~S_IA_dnbr_with,nu.formula=~S_IA_dnbr_with, tau.formula=~S_IA_dnbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
CBI.simple<-gamlss(formula=CBI.B~L_IA_rbr_with, nu.formula=~L_IA_rbr_with, tau.formula=~L_IA_rbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
BA.simple<-gamlss(formula=pdBA~L_IA_rbr_with, sigma.formula=~L_IA_rbr_with,nu.formula=~L_IA_rbr_with, tau.formula=~L_IA_rbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
### adj.lim.pdFVSVU  L_IA_rbr_with

Create predicted values of the response variable for the reserve dataset in order to calcualte confusion matrices, accuracies and kappa. 

Gamlss phrases nu and tau as odds.  The code below converts these odds of nu or tau into probabilities of 0 or 1, respectively. The predicted values are computed using the continuous response (mu) as well as the probability of zero or one.   

```{r SW RAVG adj.lim.pdFVSVU L_IA_rbr_with}
...
adj.lim.pdFVSVU.simple<-gamlss(formula=adj.lim.pdFVSVU~L_IA_rbr_with, sigma.formula=~L_IA_rbr_with,nu.formula=~L_IA_rbr_with, tau.formula=~L_IA_rbr_with,family=BEINF,data=na.omit(SWRAVG_field_train))
...
### adj.lim.pdFVSVU  S_IA_rbr_with

Create predicted values of the response variable for the reserve dataset in order to calcualte confusion matrices, accuracies and kappa. 

Gamlss phrases nu and tau as odds.  The code below converts these odds of nu or tau into probabilities of 0 or 1, respectively. The predicted values are computed using the continuous response (mu) as well as the probability of zero or one.   

```{r SW RAVG adj.lim.pdFVSVU S_IA_rbr_with}
...
```
####This SEction is beginning of offset with/without testing
...
CBI.simple<-gamlss(formula=CBI.B~S_IA_dnbr_no, nu.formula=~S_IA_dnbr_no, tau.formula=~S_IA_dnbr_no,family=BEINF,data=na.omit(SWRAVG_field_train))
...
BA.simple<-gamlss(formula=pdBA~S_IA_dnbr_no, sigma.formula=~S_IA_dnbr_no,nu.formula=~S_IA_dnbr_no, tau.formula=~S_IA_dnbr_no,family=BEINF,data=na.omit(SWRAVG_field_train))
...
### adj.lim.pdFVSVU  S_IA_dnbr_no

Create predicted values of the response variable for the reserve dataset in order to calcualte confusion matrices, accuracies and kappa. 

Gamlss phrases nu and tau as odds.  The code below converts these odds of nu or tau into probabilities of 0 or 1, respectively. The predicted values are computed using the continuous response (mu) as well as the probability of zero or one.   

```{r SW RAVG adj.lim.pdFVSVU S_IA_dnbr_no}
...
adj.lim.pdFVSVU.simple<-gamlss(formula=adj.lim.pdFVSVU~S_IA_dnbr_no, sigma.formula=~S_IA_dnbr_no,nu.formula=~S_IA_dnbr_no, tau.formula=~S_IA_dnbr_no,family=BEINF,data=na.omit(SWRAVG_field_train))
...
CBI.simple<-gamlss(formula=CBI.B~S_EA_rbr_no, nu.formula=~S_EA_rbr_no, tau.formula=~S_EA_rbr_no,family=BEINF,data=na.omit(SWRAVG_field_train))
...
BA.simple<-gamlss(formula=pdBA~S_EA_rbr_no, sigma.formula=~S_EA_rbr_no,nu.formula=~S_EA_rbr_no, tau.formula=~S_EA_rbr_no,family=BEINF,data=na.omit(SWRAVG_field_train))
...
### adj.lim.pdFVSVU  S_EA_rbr_no

Create predicted values of the response variable for the reserve dataset in order to calcualte confusion matrices, accuracies and kappa. 

Gamlss phrases nu and tau as odds.  The code below converts these odds of nu or tau into probabilities of 0 or 1, respectively. The predicted values are computed using the continuous response (mu) as well as the probability of zero or one.   

```{r SW RAVG adj.lim.pdFVSVU S_EA_rbr_no}
...
adj.lim.pdFVSVU.simple<-gamlss(formula=adj.lim.pdFVSVU~S_EA_rbr_no, sigma.formula=~S_EA_rbr_no,nu.formula=~S_EA_rbr_no, tau.formula=~S_EA_rbr_no,family=BEINF,data=na.omit(SWRAVG_field_train))
